  ...
  return (
    <footer className="bg-black text-gray-300 relative">
      ...
      <section className="text-center py-12 bg-[url('/footer-bg.jpg')] bg-cover bg-center">
        ...
        <div className="max-w-3xl mx-auto flex flex-col items-center px-4 sm:px-6">
          <p className="mb-4 text-base sm:text-lg text-gray-200 text-center">
          ...
          <div className="w-full">
            <iframe
              ...
              allowFullScreen
              loading="lazy"
              className="rounded-lg shadow-lg sm:h-[300px]"
            />
          </div>
        </div>
      </section>
      ...
      {/* Bottom Footer */}
      <div className="border-t border-gray-700 py-6 text-center text-xs sm:text-sm px-4">
        <p>
          Copyright © {new Date().getFullYear()} Gericom Links Networks. All
          rights reserved.
        </p>
        <p>
          Crafted by{" "}
          <Link
            href="https://www.deeptrack.io/"
      ...
      <a
        ...
        target="_blank"
        className="fixed bottom-4 left-4 sm:bottom-6 sm:left-6 bg-green-500 text-white px-3 py-2 sm:px-4 sm:py-3 rounded-full flex items-center gap-2 shadow-lg hover:bg-green-600 transition text-sm sm:text-base"
      >
        <svg
        ...
        <span className="hidden sm:inline">Enquire/Buy via Whatsapp</span>
