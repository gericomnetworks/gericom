...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("leading-snug font-semibold text-base sm:text-lg", className)}
      {...props}
    />
  )
}
...
function CardAction({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "col-start-2 row-span-2 row-start-1 self-start justify-self-end sm:justify-self-end justify-self-center sm:row-auto",
        className
      )}
      {...props}
    />
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex flex-wrap items-center gap-2 px-4 sm:px-6 [.border-t]:pt-6",
        className
      )}
      {...props}
    />
